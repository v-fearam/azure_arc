...
Download-Files ($templateBaseUrl + "artifacts")  @("settingsTemplate.json", "DataServicesLogonScript.ps1", "DeployPostgreSQL.ps1", "DeploySQLMI.ps1", "dataController.json", "dataController.parameters.json", "postgreSQL.json", "postgreSQL.parameters.json", "sqlmi.json", "sqlmi.parameters.json", "SQLMIEndpoints.ps1") $Env:ArcBoxDir
...
Configuring-Logon-Scripts $adminUsername "DataServicesLogonScript" ("$Env:ArcBoxDir\DataServicesLogonScript.ps1")
