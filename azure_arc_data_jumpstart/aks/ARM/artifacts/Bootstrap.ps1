...
{
    . ./CommonBootstrapArcData.ps1 $profileRootBaseUrl $templateBaseUrl $adminUsername @() "true" "false"
...
{
    . ./CommonBootstrapArcData.ps1 $profileRootBaseUrl $templateBaseUrl $adminUsername
