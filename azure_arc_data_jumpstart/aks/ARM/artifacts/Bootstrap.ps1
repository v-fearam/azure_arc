...
{
    . ./CommonBoostrapArcData.ps1 $profileRootBaseUrl $templateBaseUrl $adminUsername @() "true" "false"
...
{
    . ./CommonBoostrapArcData.ps1 $profileRootBaseUrl $templateBaseUrl $adminUsername
