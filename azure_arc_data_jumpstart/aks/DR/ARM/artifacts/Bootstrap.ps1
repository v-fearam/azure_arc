...
BootstrapArcData -profileRootBaseUrl $profileRootBaseUrl -templateBaseUrl $templateBaseUrl -adminUsername $adminUsername -avoidPostgreSQL -folder $Env:tempDir -LocalSQLMIFile
